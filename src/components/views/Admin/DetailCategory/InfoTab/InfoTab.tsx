...
const InfoTab = (props: PropTypes) => {
  ...
  useEffect(() => {
    const hasChanged = 
      nameValue !== dataCategory?.name || 
      descriptionValue !== dataCategory?.description;
    
    setIsFormChanged(hasChanged);
  }, [nameValue, descriptionValue, dataCategory]);
  ...
  return (
    <Card className="w-full p-4 lg:w-1/2">
      ...
      <CardBody>
        ...
        >
          <Skeleton className="rounded-xl" isLoaded={!!dataCategory?.name}>
            <Controller
              name="name"
